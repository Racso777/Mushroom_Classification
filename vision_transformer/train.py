...
book = xlwt.Workbook(encoding='utf-8') #create excel
# create worksheet
...
def main(args):
    ...
    # call mydataset to get train data
    train_dataset = MyDataSet(images_path=train_images_path,
                              images_class=train_images_label,
                              transform=data_transform["train"])
 
    # call mydataset to get valid data
    ...
    if args.freeze_layers:
        for name, para in model.named_parameters():
            # free all weights except head and pre_logits
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_classes', type=int, default=370)
    ...
    parser.add_argument('--data-path', type=str,
                        default="F:\mushroom_project/enhance_dataset")
    parser.add_argument('--model-name', default='', help='create model name')
 
    # pre train weight path, if you don't want to use pre trained weights, input empty string
    parser.add_argument('--weights', type=str, default='F:\mushroom_project\\vit_base_patch16_224_in21k\\vit_base_patch16_224_in21k.pth',
